...
class AttentionPool2d(nn.Module):
    def __init__(self, spacial_dim: int, embed_dim: int = 2048, num_heads: int=8, output_dim: int = 1024):
        '''
        ...
        self.positional_embedding = nn.Parameter(torch.randn(spacial_size + 1, embed_dim) / embed_dim ** 0.5)
